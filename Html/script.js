...
// ==========================================================
// newsletter.js — ارسال ایمیل کاربر به خبرنامه
// POST /api/subscribe
// شامل: Loading Spinner داخل دکمه + مدیریت خطا با try/catch
// نیازمند بارگذاری newsletter.css در صفحه
// روی همان HTML فعلی (بدون تغییر) کار می‌کند:
// <div class="Subscribe"><form><input class="EmailInput">
// <input class="SubscribeButton" type="submit"></form></div>
// ==========================================================

const BASE_URL = "https://foodieland-oq9b.onrender.com";

// پیام‌هایی که هنگام ارسال، به‌ترتیب و با تاخیر نمایش داده می‌شوند
// چون هاست رایگان ممکن است تا ۶۰ ثانیه طول بکشد تا بیدار شود
...
/**
 * ولیدیشن ساده‌ی فرمت ایمیل، قبل از ارسال درخواست
 */
...
/**
 * نمایش پیام وضعیت زیر فرم (موفقیت / خطا / اطلاع‌رسانی)
 */
...
/**
 * تغییر ظاهر دکمه به حالت "در حال ارسال" با اسپینر کوچک
 */
...
/**
 * ارسال درخواست POST به اندپوینت subscribe با مدیریت کامل خطا
 */
